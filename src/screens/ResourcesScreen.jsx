          ...
          {FILTERS.map(([id, label]) => (
            <button
              ...
              style={{
                ...
                background: filter === id ? '#EAFF00' : 'rgba(255,255,255,.13)',
                transition: 'background .15s',
              }}
            >
              <span style={{
                fontFamily: FF, fontSize: 12, fontWeight: 700,
                color: filter === id ? '#022b52' : 'rgba(255,255,255,.8)',
              }}>
                {label}
              </span>
            </button>
          ...
          return (
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 5, flexShrink: 0 }}>
                ...
                {/* External link icon */}
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke={C.text3} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
