...
export default function OnboardSchool({ onSelect, onBack }) {
  ...
  return (
    <div className="tc-screen" style={{ width:'100%', height:'100%', background:'#fff', display:'flex', flexDirection:'column', paddingTop:'env(safe-area-inset-top, 0px)', alignItems:'center' }}>
      <div style={{ width:'100%', maxWidth:540, display:'flex', flexDirection:'column', flex:1, minHeight:0 }}>
