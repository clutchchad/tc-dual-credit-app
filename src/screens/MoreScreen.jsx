...
// ---------------------------------------------------------------------------
// Achievements shelf — UI scaffold only, no logic wired yet
// ---------------------------------------------------------------------------
const BADGE_PLACEHOLDERS = [
  { key: 'a', label: 'First Step'  },
  { key: 'b', label: 'Enrolled'    },
  { key: 'c', label: 'On Track'    },
  { key: 'd', label: 'Milestone'   },
  { key: 'e', label: 'Scholar'     },
];
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 6, width: 56 }}>
      <div style={{
        ...
        background: 'rgba(6,89,144,.06)',
        border: '2px dashed rgba(6,89,144,.18)',
        display: 'flex', alignItems: 'center', justifyContent: 'center',
      }}>
        {/* Padlock icon */}
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="rgba(6,89,144,.28)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <rect x="3" y="11" width="18" height="11" rx="2"/>
          <path d="M7 11V7a5 5 0 0110 0v4"/>
        </svg>
      </div>
      <span style={{ fontFamily: FF, fontSize: 9, fontWeight: 600, color: 'rgba(6,89,144,.3)', textAlign: 'center', lineHeight: 1.3 }}>
        {label}
      </span>
    </div>
  );
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }}>
        <div>
          ...
          <div style={{ fontFamily: FF, fontSize: 12, color: C.text3, marginTop: 2 }}>
        ...
        <div style={{
          ...
          <span style={{ fontFamily: FF, fontSize: 10, fontWeight: 700, color: C.blue, letterSpacing: '0.3px' }}>
            Coming soon
          </span>
        </div>
      </div>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', paddingLeft: 2, paddingRight: 2 }}>
        {BADGE_PLACEHOLDERS.map(b => (
          <LockedBadge key={b.key} label={b.label} />
        ))}
      </div>
    </div>
  );
